...
- **usuarios** → tienen pedidos y reseñas
- **categorias** → agrupan productos
- **productos** → pertenecen a categorías, aparecen en reseñas y detallePedidos
- **pedidos** → pertenecen a usuarios, tienen detallePedidos y pagos
- **detallePedidos** → relacionan pedidos con productos
- **pagos** → asociados a pedidos
- **resenas** → hechas por usuarios sobre productos
